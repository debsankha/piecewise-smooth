...
{\LARGE Investigating Piecewise Smooth Hybrid Systems}\\[0.2\baselineskip] % Title

\rule{\textwidth}{0.4pt}\vspace*{-\baselineskip}\vspace{3.2pt} % Thin horizontal line
\rule{\textwidth}{1.6pt}\\[\baselineskip] % Thick horizontal line

\scshape % Small caps
5th Year Integrated MS Dissertation
...
By \\[\baselineskip]
{\Large Debsankha Manik\par} % Editor list
\vspace*{\baselineskip} 
{\itshape Under the Supervision of\par} % Editor affiliation
\vspace*{\baselineskip} 
{\Large Prof. Soumitro Banerjee}

\vfill % Whitespace between editor names and publisher logo


\def\svgwidth{0.4\columnwidth}
\includesvg{iiser-logo}\\
\vspace*{\baselineskip} % Whitespace between location/year and editors
{\large Department of Physical Sciences\par}
{\large Indian Institute of Science Education and Research, Kolkata\par}
{\large Mohanpur, Nadia}

{\scshape May 2013} \\[0.3\baselineskip] % Year published
\endgroup}
...
and Research $-$ Kolkata in partial fulfillment of the requirements for the 
award of the Integrated BS $-$ MS degree, embodies the research work done by 
\emph{Debsankha Manik} under my supervision at IISER $-$ Kolkata. The work 
presented here is original and has not been submitted so far, in part or full, 
for any degree or diploma of any other university/institute. \\
\vspace{0.3in} \\
...
\begin{tiny}
\begin{figure}
\caption{Stability of $P1C1$ orbits near grazing}
\label{fig-int-nonint}
\begin{center}
...
In Fig \ref{fig-int-nonint} , we plot the results of such numerical 
calculation in the case of $n=2.235$ and $n=2$.  We can easily see that in the 
first case ($n\notin\mathbb{N}$), when $F$ is 
...
However, in the case of $n=2$, as opposed to the previous case, no 
