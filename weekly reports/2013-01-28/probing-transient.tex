...
\begin{frame}{Probing 'em harder wrt G}
\begin{itemize}
\item At first glance, bumps in $\tau$ seems to coincide with the appearance 
...
the bumps. 
\item Does this mean some other period 1 orbits are appearing with high 
transient stability?
\item Are the higher periodic orbits at all real? Might they not be the 
artifact of our finite  $\varepsilon$ for determining periodic orbits?
\item If they are indeed real, could it happen that some points which would ultimately go to a 
