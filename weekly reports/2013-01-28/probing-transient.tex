...
\begin{frame}
\begin{figure}
\caption{With errorbars}%head chopped as well
\begin{center}
...
in Dissipative Dynamical Systems'' by Yves Pomeau and Paul Manneville,
...
\caption{}
\begin{center}
\includegraphics[width=0.7\columnwidth]{intermit-lorenz-expl}
\end{center}
\end{figure}
\end{frame}
...
\bibitem{} Celso Grebogi, Edward Ott, James A.   Yorke , Fractal Basin 
